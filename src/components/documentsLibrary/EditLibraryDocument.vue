<template>
    <div>
        <el-dialog :title="$t('message.edit',{typeName:$t('message.doc')})" :visible="editFileVisible" 
            ...
            <div class="dialog-con">
                <el-form label-width="80px" ref="editFileForm" :model="editFileForm" :rules="rules" class="passwordForm editFileForm">
                    <el-form-item label="归档名称:" required prop="fileName">
                        <el-input v-model.trim="editFileForm.fileName" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="文档分类:" required prop="fileClassify">
                    ...
                    <el-form-item label="密级:" required prop="secretDegree">
                        <el-radio-group v-model="editFileForm.secretDegree">
                            <el-radio :label="1">公开</el-radio>
                            <el-radio :label="2">内部</el-radio>
                            <el-radio :label="3">秘密</el-radio>
                            <el-radio :label="4">机密</el-radio>
                            <el-radio :label="5">绝密</el-radio>
                        </el-radio-group>
                    </el-form-item>
                </el-form>
            </div>
        ...
        <el-dialog :title="$t('message.docClassify')" :close-on-click-modal="false" 
            ...
            <div class="dialog-con">
                <el-checkbox-group v-model="selectedClassify">
                    <el-checkbox label="双皮奶" v-for="(docClassify,index) in documentClassifyAry" :key="index"></el-checkbox>
...
export default {
    ...
    computed:{
        ...mapState(['documentClassifyAry']),
    },
    methods:{
        //编辑文件确认
        submitEditFile(){
            docLibraryApi.editLibraryDocRequest({
        ...
        setFormDefaultVal(){
            ...
            this.editFileForm.secretDegree=this.curOperateFile.secretDegree;
        },
        //选择文档分类
        selectClassify(){
